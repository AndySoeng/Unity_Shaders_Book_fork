Shader "Unity Shaders Book Learn/Chapter 15/Water Wave"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                i.scrPos.xy = offset.xy * i.scrPos.z + i.scrPos.xy;
                fixed3 refrColor = tex2D(_RefractionTex, i.scrPos.xy / i.scrPos.w);
                ...
                fixed3 finalColor = reflColor.rgb * fresnel + refrColor.rgb * (1 - fresnel);
