Shader "Unity Shaders Book Learn/Chapter 7/Normal Map In Tangent Space"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(a2v v)
            {
                ...
                //Constuct a matricx that transform a point/vector from tangent space to world space
				...
				*/
                ...
                // //float3 binromal = cross(normalize(v.normal), normalize(v.tangent.xyz)) * v.tangent.w;
                // //Construct matrix which transform vectors form object space to tangent space
                ...
                // //Transform the view direction form object space to tangent space;
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                //If the texutre is not marked as "Normal" map"
